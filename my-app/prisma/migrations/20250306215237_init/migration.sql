...
CREATE TABLE "new_Player" (
    ...
    CONSTRAINT "Player_serverId_fkey" FOREIGN KEY ("serverId") REFERENCES "Servidor" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_Player" ("admin", "id", "name", "serverId", "victorias") SELECT "admin", "id", "name", "serverId", "victorias" FROM "Player";
DROP TABLE "Player";
